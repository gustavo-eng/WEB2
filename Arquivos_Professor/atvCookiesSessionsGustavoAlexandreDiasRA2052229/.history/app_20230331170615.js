...
// secret ele vai usar para algumas criptografias internas e quanto tempo de vida o cookie vai ter (e consequentemente a sessão).
...
//cadastrar  /logout
//app.use('/', indexRouter);
app.use('/',authenticationMiddleware, loginRouter);
