...
let controlaAcesso = function (req, res, next) {
  ...
  jwt.verify('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiZmFzZGZhIiwiaWF0IjoxNjgxOTI4ODIyLCJleHAiOjE2ODE5MjkxMjJ9.cWm0H-C6iTWsharVuOsbyS616L0L_a8uGG0fKrq6kZo","usuario', "A1B2C3D4", (err, decoded) => {
    if (!err) {
