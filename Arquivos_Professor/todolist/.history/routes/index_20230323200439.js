...
router.get('/', function(req, res, next) {
  if (Task.list().length == 0) { // vai ter sempre  duas tarefas
    Task.new("Tarefa 1");
    Task.new("Tarefa 2");
  }

  let obj = Task.getElementById(req.query.tid); //De onde vem esse query  
  res.render('index', { tasks: Task.list(), task: obj }); //sao parametros capturados no arquivo mustache 
});
