...
/* 
opcao alternativa de middleware feito pelo professor 
...
app.post('/', (req, res) => { // melhorar codigo e passar para funcoes externas 
    /* 
...
app.get('/atividade5/numeroIndeterminado', (req, res) => {
    ...
    listNumeros[0].forEach(elemento => { // teve que ser [0], pq tinha uma lista dentro de outra  lista 
...
// usando o joi
const validador = require('./exemploJoi.js')
app.get('/joi/valida', validador ,(req, res) => {
    //const {error, value} = validador.validate(req.query)
    //console.log(error, value)
    res.send('Fanilizado a rota /joi/valida (id) ==' + req.query.id)
})
