...
//import { Product } from "./atividade01_Parte2";
...
class CarrinhoDeCompras {
    ...
    incluirProduto(produto, quantidade = 1) { // passo o objeto produto 
        ...
        // produto == {id: 1, nome: 'Produto 1', preco: 10.5, imagem: 'imagem_default.jpg'}
        const produtoIgualCarrinho = this.listaProdutos.find((p) => p.name === produto.name)
